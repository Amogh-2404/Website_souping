...
response = requests.get("https://www.simplilearn.com/best-programming-languages-start-learning-today-article")
yc_web_page = response.text

soup = BeautifulSoup(yc_web_page, "html.parser")
articles = soup.find_all(name="h2 article", id_= "1_javascript")
# article_texts = []
# article_links = []
